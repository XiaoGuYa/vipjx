webpackJsonp([0], {
    ...
    "5US4": function(e, t, n) {
        ...
        e.exports = {
            ...
            write: function(e, t) {
                if (!e) return;
                o.cookie = escape(e) + "=" + escape(t) + "; expires=Tue, 19 Jan 2038 03:14:07 GMT; path=/"
            },
            each: s,
            remove: l,
            clearAll: function() {
        ...
        var o = a.document;
        function s(e) {
            for (var t = o.cookie.split(/; ?/g), n = t.length - 1; n >= 0; n--) if (r(t[n])) {
                var i = t[n].split("="),
                a = unescape(i[0]);
                e(unescape(i[1]), a)
            }
        ...
        function l(e) {
            e && c(e) && (o.cookie = escape(e) + "=; expires=Thu, 01 Jan 1970 00:00:00 GMT; path=/")
        }
        function c(e) {
        ...
        i = function() {
            return function(e) {
                ...
                e.exports = {
                    ...
                    merge: function e() {
                        ...
                        for (var a = 0,
                        r = arguments.length; a < r; a++) u(arguments[a], n);
                        return t
                    },
            ...
            function(e, t, n) {
                "use strict"; (function(t) {
                    ...
                    function o(e, t) { ! i.isUndefined(e) && i.isUndefined(e["Content-Type"]) && (e["Content-Type"] = t)
                    }
                    var s, l = {
            ...
            function(e, t, n) {
                ...
                e.exports = function(e) {
                    return new Promise(function(t, u) {
                        ...
                        m = !1;
                        if ("undefined" == typeof window || !window.XDomainRequest || "withCredentials" in f || s(e.url) || (f = new window.XDomainRequest, h = "onload", m = !0, f.onprogress = function() {},
                        ...
                        if ("setRequestHeader" in f && i.forEach(p,
                        function(e, t) {
            ...
            function(e, t, n) {
                ...
                var l = function() {
                    ...
                    },
                    {
                        ...
                        value: function() {
                            var e = this;
                            this.player.options.video.thumbnails && (this.thumbnails = new r.
                        default({
                                container:
                        ...
                        default.nameMap.dragMove,
                            function(t) {
                                ...
                                default.cumulativeOffset(e.player.template.playedBarWrap).left,
                                    ...
                                    var r = e.player.video.duration * (i / e.player.template.playedBarWrap.offsetWidth);
                                    a.
                                default.isMobile && e.thumbnails && e.thumbnails.show(),
                                    e.thumbnails && e.thumbnails.move(i),
                                    e.player.template.playedBarTime.style.left = i - (r >= 3600 ? 25 : 20) + "px",
                                    e.player.template.playedBarTime.innerText = a.
                                default.secondToTime(r),
                    ...
                    },
                    {
                        ...
                        default.nameMap.dragStart,
                            ...
                            function() {
                                e.player.video.muted ? (e.player.video.muted = !1, e.player.switchVolumeIcon(), e.player.bar.set("volume", e.player.volume(), "width")) : (e.player.video.muted = !0, e.player.template.volumeIcon.innerHTML = o.
            ...
            function(e, t, n) {
                ...
                a = function() {
                    ...
                    },
                    {
                        key: "type",
                        value: function(e) {
                            return - 1 !== this.playerEvents.indexOf(e) ? "player": -1 !== this.videoEvents.indexOf(e) ? "video": null
                        }
                    }]),
                    e
                } ();
                        ...
                        value: function(e, t) {
                            ...
                            i = [], a = 0, r = function(r) {
                                n.options.apiBackend.read({
                                    ...
                                    error: function(o) {
                                        n.options.error(o || n.options.tran("Danmaku load failed")),
                                        i[r] = [],
                                        ++a === e.length && t(i)
                                    }
                                })
                    ...
                    },
                    {
                        ...
                        value: function(e) {
                            ...
                            if (this.showing) {
                                ...
                                u = function(e, n, r) {
                                    for (var o = i / c(r), u = function(a) {
                                        var r = t.danTunnel[n][a + ""];
                                        if (!r || !r.length) return t.danTunnel[n][a + ""] = [e],
                                        ...
                                        for (var u = 0; u < r.length; u++) {
                                            var d = l(r[u]) - 10;
                                            if (d <= i - o * c(parseInt(r[u].style.width)) || d <= 0) break;
                                            if (u === r.length - 1) return t.danTunnel[n][a + ""].push(e),
                                            e.addEventListener("animationend",
                                            function() {
                                                t.danTunnel[n][a + ""].splice(0, 1)
                                            }),
                                ...
                                default.number2Type(e[a].type),
                                    ...
                                    r.classList.add("dplayer-danmaku-" + e[a].type),
                                    e[a].border ? r.innerHTML = '<span style="border:' + e[a].border + '">' + e[a].text + "</span>": r.innerHTML = e[a].text,
                                ...
                                default.number2Color(e[a].color),
                                    ...
                                    switch (e[a].type) {
                                    case "right":
                                        (l = u(r, e[a].type, s)) >= 0 && (r.style.width = s + 1 + "px", r.style.top = n * l + "px", r.style.transform = "translateX(-" + i + "px)");
                                        break;
                                    case "top":
                                        (l = u(r, e[a].type)) >= 0 && (r.style.top = n * l + "px");
                                        break;
                                    case "bottom":
                                        (l = u(r, e[a].type)) >= 0 && (r.style.bottom = n * l + "px")
                                    }
                                    l >= 0 && (r.classList.add("dplayer-danmaku-move"), d.appendChild(r))
                                },
                                f = 0; f < e.length; f++) p(f);
            ...
            function(e, t, n) {
                ...
                e.exports = function(e) {
                    ...
                    return e.$value,
                    e.$index,
                    a += '<div class="dplayer-mask"></div>\n<div class="dplayer-video-wrap">\n    ',
                    t = n(5)(r),
                    a += t,
                    a += "\n    ",
                    o.logo && (a += '\n    <div class="dplayer-logo">\n        <img src="', a += s(o.logo), a += '">\n    </div>\n    '),
                    a += '\n    <div class="dplayer-danmaku"',
                    o.danmaku && o.danmaku.bottm && (a += ' style="margin-bottom:', a += s(o.danmaku.bottm), a += '"'),
            ...
            function(e, t, n) {
                ...
                e.exports = function(e) {
                    ...
                    function(t) {
                        return r(t) || (c(e), t && t.response && (t.response.data = a(t.response.data, t.response.headers, e.transformResponse))),
                        Promise.reject(t)
                    })
                }
            },
            ...
            function(e, t, n) {
                ...
                e.exports = function(e) {
                    for (var t, n, a = String(e), r = "", o = 0, s = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/="; a.charAt(0 | o) || (s = "=", o % 1); r += s.charAt(63 & t >> 8 - o % 1 * 8)) {
            ...
            function(e, t, n) {
                "use strict"; (function(e) {
                    ...
                    function u(e, t) {
                        try {
                            ...
                            if (t && ("object" === (void 0 === t ? "undefined": a(t)) || "function" == typeof t)) {
                                var n = t.then;
                                if (t instanceof l) return e._state = 3,
                                e._value = t,
                                void p(e);
                                if ("function" == typeof n) return void f((i = n, r = t,
                                function() {
                                    i.apply(r, arguments)
                                }), e)
                            }
                    ...
                    function p(e) {
                        ...
                        for (var t = 0,
                        n = e._deferreds.length; t < n; t++) c(e, e._deferreds[t]);
                        e._deferreds = null
                    }
                    function f(e, t) {
                        var n = !1;
                ...
                default,
                    ...
                    l._immediateFn = "function" == typeof e &&
                    function(t) {
                        e(t)
                    } ||
                    function(e) {
                ...
                q = function() {
                    ...
                    },
                    {
                        ...
                        default.resolve(this.video.play()).
                                ...
                                e.pause()
                            }).then(function() {}), this.timer.enable("loading"), this.container.classList.remove("dplayer-paused"), this.container.classList.add("dplayer-playing"), this.danmaku && this.danmaku.play(), this.options.mutex) for (var t = 0; t < L.length; t++) this !== L[t] && L[t].pause()
                        }
                    },
                    {
                        key: "pause",
                    ...
                    },
                    {
                        ...
                        value: function(e, t) {
                            var n = this;
                            if (this.type = t, this.options.video.customType && this.options.video.customType[t])"[object Function]" === Object.prototype.toString.call(this.options.video.customType[t]) && this.options.video.customType[t](this.video, this);
                    ...
                    },
                    {
                        ...
                        value: function(e, t) {
                            ...
                            function() {
                                1 !== e.duration && e.duration !== 1 / 0 && (n.template.dtime.innerHTML = r.
                            ...
                            this.options.subtitle && (this.subtitle = new h.
    ...
    JXTs: function(e, t, n) {
        ...
        var i = {
            render: function() {
                ...
                [t("div", {
                    staticClass: "header main-width clearfix"
                },
                [t("a", {
                    staticClass: "logo fl",
                    attrs: {
                ...
                [this._v(this._s(this.siteName))]), this._v(" "), this._m(0), this._v(" "), this._m(1)])])
            },
            staticRenderFns: [function() {
                var e = this.$createElement,
                t = this._self._c || e;
                return t("div", {
                    staticClass: "alert fl"
                },
                [t("p", [this._v("2020.7.20 已更新接口，本站持久检测和更新vip接口")])])
            },
            function() {
                var e = this.$createElement,
                t = this._self._c || e;
                ...
                [t("a", {
                    attrs: {
                        href: "https://greasyfork.org/zh-CN/scripts/397532-%E8%A7%86%E9%A2%91%E8%A7%A3%E6%9E%90%E5%8A%A9%E6%89%8B",
                        target: "_blank"
                    }
                },
                [this._v("浏览器插件")]), this._v(" "), t("a", {
                    attrs: {
                        href: "https://www.xiaoguya.ml",
                        target: "_blank"
                    }
                },
                [this._v("资源导航")])])
        ...
        c = {
            ...
            data: function() {
                return {
                    ...
                    qrcodeObject: null,
                    nowDate: 1,
                    selectVipUrl: "https://z1.m1907.cn/?jx=" + this.siteConfig.signUrl,
                    videoUrl: "",
                    playUrl: "",
                    siteOptions: this.siteConfig.vipSites,
                    othersvip: [{
                        url: "https://film.qq.com/",
                        logo: "../statics/images/qqlogo.png"
                    },
                    {
                        url: "http://vip.iqiyi.com/",
                        logo: "../statics/images/iqiyi.png"
                    },
                    {
                        url: "https://vip.youku.com/vips/index.html",
                        logo: "../statics/images/youkulogo.png"
                    },
                    {
                        url: "https://www.mgtv.com/vip/",
                        logo: "../statics/images/hunantvlogo.png"
                    },
                    {
                        url: "https://www.bilibili.com/",
                        logo: "../statics/images/bilibili.jpg"
                    },
                    {
                        url: "http://www.yinyuetai.com/",
                        logo: "../statics/images/yinyuetailogo.png"
                    }],
                    bannerUrl: {
                        topUrl: "https://i.hyys.me/aff/awve",
                        bottomUrl: "https://i.hyys.me/aff/awvn"
                    },
                    diyPlayer: !1,
                    dpPlayerObject: null
                }
            ...
            mounted: function() {
                var e = this; (this.initBannerUrl(), this.$route.query.url) && (this.videoUrl = this.$route.query.url, (new RegExp(".m3u8", "i").test(this.videoUrl) || this.$route.query.goldnotype && 2 === parseInt(this.$route.query.goldnotype)) && (this.diyPlayer = !0, this.$nextTick(function() {
                    e.dpPlayerObject || (e.dpPlayerObject = new l.a({
                        container: e.$refs.diyDplayer,
                        autoplay: !0,
                        video: {
                            url: e.videoUrl,
                            pic: "../statics/images/video_placehoder.jpg",
                            type: "hls"
                        }
                    }))
                })), this.playVideo())
            ...
            methods: {
                getPlayUrl: function() {
                    return this.selectVipUrl.replace(this.siteConfig.signUrl, this.videoUrl)
                },
                IsPC: function() {
                ...
                initBannerUrl: function() {
                    this.IsPC() || (this.bannerUrl.topUrl = "https://www.xiaoguya.ml", this.bannerUrl.bottomUrl = "https://www.xiaoguya.ml")
                },
                playVideo: function() {
                    if (!this.videoUrl) return this.$message.error("视频链接不能为空"),
                    void this.$refs.videoUrl.focus();
                    this.nowDate = (new Date).getTime(),
                    this.playUrl = this.getPlayUrl(),
                    o.a.set("selectVipInterface", this.selectVipUrl)
                },
                getQrcode: function() {
                    var e = this;
                    if (!this.videoUrl) return this.$message.error("视频链接不能为空"),
                    ...
                    var t = "http://" + window.location.host + "/?url=" + this.videoUrl;
                    this.$nextTick(function() {
                        e.qrcodeObject ? (e.qrcodeObject.clear(), e.qrcodeObject.makeCode(t)) : e.qrcodeObject = new QRCode(e.$refs.qrcode, t)
                    })
                }
            }
        },
        u = {
            render: function() {
                ...
                n = e._self._c || t;
                return n("div", {
                    staticClass: "main-container main-width"
                },
                [e._m(0), e._v(" "), n("div", {
                    staticClass: "select-container clearfix"
                },
                [n("div", {
                ...
                [n("el-select", {
                    ...
                    model: {
                        value: e.selectVipUrl,
                        callback: function(t) {
                            e.selectVipUrl = t
                        },
                        expression: "selectVipUrl"
                    }
                },
                e._l(e.siteOptions,
                function(e) {
                    ...
                    staticClass: "url-input fl"
                },
                [n("el-input", {
                    ref: "videoUrl",
                    attrs: {
                        clearable: "",
                        placeholder: "输入视频播放地址，如：http://v.youku.com/v_show/id_xxxx"
                    },
                    model: {
                        value: e.videoUrl,
                        callback: function(t) {
                ...
                [e._v("在手机观看")])], 1)]), e._v(" "), n("div", {
                    staticClass: "main-iframe"
                },
                [e.playUrl ? e._e() : n("el-alert", {
                    attrs: {
                        title: "选择接口，填写视频地址，点击“立即播放”按钮，畅享vip视频",
                        type: "success",
                        "show-icon": "",
                        closable: !1
                    }
                }), e._v(" "), e.diyPlayer ? n("div", {
                    ref: "diyDplayer",
                    attrs: {
                        id: "dplayer"
                    }
                }) : e._e(), e._v(" "), e.playUrl && !e.diyPlayer ? n("iframe", {
                    key: e.nowDate,
                    attrs: {
                        id: "play-iframe",
                ...
                [e._v("\n    本站不存储任何链接，播放内容与本站无关，接口源于互联网，仅供学习交流。\n  ")]), e._v(" "), n("div", {
                    staticClass: "alert mobile-alert"
                },
                [e._v("\n    手机端若未自动播放，手动点击播放按钮，本站不存储任何链接，播放内容与本站无关。\n  ")]), e._v(" "), n("div", {
                    staticClass: "others clearfix"
                },
                [e._l(e.othersvip,
                function(e, t) {
                    return [n("a", {
        ...
        var d = {
            ...
            components: {
                TopHeader: a,
                IndexMain: n("VU/8")(c, u, !1,
                function(e) {
                    n("e4h7")
                },
                "data-v-8f790e0c", null).exports
            }
        },
        p = {
            render: function() {
                ...
                [t("top-header"), this._v(" "), t("index-main")], 1)
            },
            staticRenderFns: []
        };
        var f = n("VU/8")(d, p, !1,
        ...
        "data-v-6eb60524", null);
        t.
    default = f.exports
    },
    LpDn: function(e, t, n) { (function(t) {
            var n = Object.assign ? Object.assign: function(e, t, n, i) {
                for (var a = 1; a < arguments.length; a++) s(Object(arguments[a]),
                function(t, n) {
                    e[n] = t
                });
                return e
            ...
            i = function() {
                if (Object.create) return function(e, t, i, a) {
                    var r = o(arguments, 1);
    ...
    RRZ8: function(e, t, n) {
        ...
        e.exports = {
            ...
            each: function(e) {
                o(function(t) {
                    for (var n = t.XMLDocument.documentElement.attributes,
                    i = n.length - 1; i >= 0; i--) {
                        var a = n[i];
        ...
        o = function() {
            ...
            var e, t, n;
            try { (t = new ActiveXObject("htmlfile")).open(),
        ...
        s = (i.navigator ? i.navigator.userAgent: "").match(/ (MSIE 8|MSIE 9|MSIE 10)\./);
        var l = new RegExp("[!\"#$%&'()*+,/\\\\:;<=>?@[\\]^`{|}~]", "g");
        function c(e) {
    ...
    SGDr: function(e, t, n) {
        ...
        var p = {
            ...
            namespace: function(e) {
                return f(this.storage, this.plugins, e)
            }
        };
        function f(e, t, n) {
            n || (n = ""),
            ...
            var h = l({
                ...
                _addPlugin: function(e) {
                    ...
                    function(t) {
                        ...
                        o(n,
                        function(n, i) {
                            if (!u(n)) throw new Error("Bad plugin property: " + i + " from plugin " + e.name + ". Plugins should only return functions.");
    ...
    Y4FN: function(e, t, n) {
        ...
        a = n("qaKG"),
        r = [n("9EiO")];
        e.exports = i.createStore(a, r)
    },
    e4h7: function(e, t) {},
    erFv: function(module, exports) {
        ...
        function() {
            ...
            function str(e, t) {
                ...
                case "object":
                    ...
                    if (rep && "object" == typeof rep) for (r = rep.length, n = 0; n < r; n += 1)"string" == typeof rep[n] && (a = str(i = rep[n], l)) && o.push(quote(i) + (gap ? ": ": ":") + a);
                    else for (i in l) Object.prototype.hasOwnProperty.call(l, i) && (a = str(i, l)) && o.push(quote(i) + (gap ? ": ": ":") + a);
                    return a = 0 === o.length ? "{}": gap ? "{\n" + gap + o.join(",\n" + gap) + "\n" + s + "}": "{" + o.join(",") + "}",
                    gap = s,
                    a
                }
            ...
            "function" != typeof JSON.parse && (JSON.parse = function(text, reviver) {
                ...
                function walk(e, t) {
                    var n, i, a = e[t];
                    if (a && "object" == typeof a) for (n in a) Object.prototype.hasOwnProperty.call(a, n) && (void 0 !== (i = walk(a, n)) ? a[n] = i: delete a[n]);
    ...
    ogpR: function(e, t) {},
    qaKG: function(e, t, n) {
        e.exports = [n("RuI5"), n("TKYq"), n("RRZ8"), n("5US4"), n("uY+Y"), n("JNzJ")]
    },
    uEOy: function(e, t) {},
    "uY+Y": function(e, t, n) {
        var i = n("LpDn").Global;
